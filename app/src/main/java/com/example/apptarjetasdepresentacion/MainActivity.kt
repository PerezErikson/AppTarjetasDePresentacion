...
fun AppTarjeta(){
    Box(
        ...
        Box(Modifier.align(Alignment.Center)) {
            PersonalDetails(name = "Erikson Perez", job = "Ing. Sistema", modifier = Modifier.align(Alignment.Center))
        }
...
fun MoreDetails(modifier: Modifier){
    Column(
        ...
        Details(detail = "8098972083", painterResource(R.drawable.phone))
        Details(detail = "www.eriksonperez.com", painterResource(R.drawable.web))
        Details(detail = "perezerikson@gmail.com", painterResource(R.drawable.email))
